...
- **Neural network stacks** (`stnet.nn`): spatio-temporal MultiViewFuser/TokenCollector blocks, attention variants, scaler + recorder modules, AMP negotiation guard band (`ModelConfig.safety_margin_pow2`).
