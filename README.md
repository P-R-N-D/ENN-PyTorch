...
The backend treats `"disabled"`, `"none"`, or an empty string as an explicit request to skip compilation. The helper in `stnet.backend.fx.compile` normalizes the value, trims whitespace, and avoids
