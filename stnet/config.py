...
def _as_tuple_nd(value: Union[int, Tuple[int, ...]], *args: Any, dims: int, name: str) -> Tuple[int, ...]:
    if isinstance(value, int) and not isinstance(value, bool):
        return (value,) * dims
...
def _enforce_equal_dims(value: Union[int, Tuple[int, ...]], *args: Any, dims: int, name: str) -> None:
