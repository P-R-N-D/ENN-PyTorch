...
class GLU(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.hid = int(hidden_dim)  # kept for backward-compat & brevity
        ...
        # One projection, then split into (a, b) gates.
        self.in_proj = nn.Linear(self.in_dim, 2 * self.hid, bias=bias)

        # Avoid overhead when dropout is disabled.
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            dropout=dropout,
            bias=bias,
            activation=nn.GELU(),  # approximate='none' by default
